...
class Solution0100Test {
    ...
    static Stream<Arguments> getIsSameTreeArgs() {
        return Stream.of(
                Arguments.of(TreeNode.fromVarargArray(1, 2, 3), TreeNode.fromVarargArray(1, 2, 3), true),
                Arguments.of(TreeNode.fromVarargArray(1, 2), TreeNode.fromVarargArray(1, null, 2), false),
                Arguments.of(TreeNode.fromVarargArray(1, 2, 1), TreeNode.fromVarargArray(1, 1, 2), false)
        );
    }
