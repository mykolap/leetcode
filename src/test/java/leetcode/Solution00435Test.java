...
class Solution00435Test {
    ...
    void eraseOverlapIntervalsSortByEnd(int[][] intervals, int expected) {
        int actual = new Solution00435().eraseOverlapIntervalsSortByEnd(intervals);
    ...
    void eraseOverlapIntervalsSortByStart(int[][] intervals, int expected) {
        int actual = new Solution00435().eraseOverlapIntervalsSortByStart(intervals);
        assertEquals(expected, actual);
    }
}